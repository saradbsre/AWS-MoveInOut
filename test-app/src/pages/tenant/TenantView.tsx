...
import TenantPDF from '../moveinout/TenantPDF';
...
return (
  <>
    {showModal && (
      ...
      <div id="pdf-report" ref={printRef} className="print-container p-4 max-w-4xl mx-auto space-y-6 bg-white print-modal">
