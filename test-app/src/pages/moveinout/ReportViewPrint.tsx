...
export default function ReportViewPrint({
  reportData,
  selectedEquipment,
  fromHistory,
  username = 'User'
      ...
      <div className="w-full">
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            <span>
              Reference No: <span className="text-left">{reportData.refNum}</span>
            </span>
          ...
          <table className="w-full border-collapse border border-black bg-white no-wrap-table">
            <tbody>
              ...
              <tr>
                ...
                <td className="w-1/2 bg-white p-2 text-xs font-normal text-black border border-black" colSpan={5}>{reportData.build_desc}</td>
              </tr>
              <tr>
                <td className="w-1/6 bg-white p-2 text-xs font-bold text-black border border-black">Unit</td>
                <td className="w-1/4 bg-white p-2 text-xs font-normal text-black border border-black">{reportData.unit}</td>
                <td className="w-1/6 bg-white p-2 text-xs font-bold text-black border border-black">Unit Nature</td>
                <td className="w-1/4 bg-white p-2 text-xs font-normal text-black border border-black">{reportData.unitNature === "R"
  ? "Residential"
  : reportData.unitNature === "C"
    ? "Commercial"
    : reportData.unitNature || "-"}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="w-1/4 bg-white p-2 text-xs font-normal text-black border border-black">{reportData.startDate}</td>
              </tr>
              <tr>
                ...
                <td className="w-1/4 bg-white p-2 text-xs font-normal text-black border border-black">{reportData.endDate}</td>
              </tr>
            </tbody>
          </table>
        </div>
