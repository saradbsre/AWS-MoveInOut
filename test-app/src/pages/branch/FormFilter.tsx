...
console.log('unitMasterDesc:', unitMasterDesc);
...
>
  ...
  {allowedRoomTypes.map(rt => (
    <option key={rt} value={rt}>{rt}</option>
        ...
        <label className="block text-sm font-medium text-gray-700 mb-1">Affected Area<span className="text-red-600">*</span></label>
        <input
          type="text"
          placeholder="Search..."
