...
const { contracts,buildings, unit, tenant, technicians, equipments, Area, 
        insertchecklist,
        // insertComplaint, GetComplaints, insertcomplaintdetails , 
        ...
        DeleteTechnicianFromUser, DeleteCatTech, 
        // addComplaintCategory, deleteComplaintCategory,
        // GetComplaintTypes, 
        GetChecklist, GetCategoryItems, 
        // insertAssignedComplaint,
        // getAssignedComplaints, CloseComplaint 
